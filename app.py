...
# ═══════════════════════════════════════════════════
    ...
    st.markdown("""
<div class="project-card">
    <div class="project-title">🧠 VisionNet | Image Classification using CNN</div>
    <div class="project-tags">
    ...
    <div class="project-bullet">Designed and developed a Convolutional Neural Network (CNN) from scratch to classify images across 10 object categories using the CIFAR-10 dataset</div>
    <div class="project-bullet">Trained and evaluated the model on 60,000+ images (50,000 train / 10,000 test) spanning classes such as airplanes, automobiles, birds and ships</div>
    <div class="project-bullet">Architected a 3-layer CNN with Conv2D, ReLU activations and MaxPooling layers with progressively increasing filters (32 → 64 → 128) for hierarchical feature extraction</div>
    <div class="project-bullet">Optimized using Adam optimizer and CrossEntropyLoss, reducing training loss from 0.75 to 0.11 over 10 epochs</div>
    <div class="project-bullet">Achieved 74.71% test accuracy on unseen data demonstrating strong generalization of learned feature representations</div>
    <div class="techstack-row">
        <b>Tech Stack:</b>
        <span>Python</span> | <span>PyTorch</span> | <span>Torchvision</span> | <span>CNN</span> | <span>Jupyter Notebook</span>
    </div>
</div>
""", unsafe_allow_html=True)
    st.markdown("""
    <div class="project-card">
        <div class="project-title">💬 SentiRNN | Movie Review Sentiment Analysis</div>
        <div class="project-tags">
            <span class="project-tag">Deep Learning</span>
            <span class="project-tag">NLP</span>
            <span class="project-tag">PyTorch</span>
            <span class="project-tag">RNN</span>
            <span class="project-tag">Text Classification</span>
        </div>
        <div class="project-bullet">Designed and developed an RNN-based sentiment analysis system to classify 50,000+ IMDB movie reviews as Positive or Negative</div>
        <div class="project-bullet">Built a 6-step NLP preprocessing pipeline including lowercasing, URL/HTML removal, stopword filtering, and stemming using NLTK and Regex</div>
        <div class="project-bullet">Applied TF-IDF Vectorization (top 5000 features) to convert cleaned text into numerical feature matrices for model input</div>
        <div class="project-bullet">Architected a custom RNN using PyTorch with 128 hidden units, BCELoss, Sigmoid activation and Adam optimizer for binary classification</div>
        <div class="project-bullet">Achieved 85.15% test accuracy on 9,917 unseen reviews across 10 training epochs</div>
        <div class="techstack-row">
            <b>Tech Stack:</b>
            <span>Python</span> | <span>PyTorch</span> | <span>NLTK</span> | <span>Scikit-learn</span> | <span>TF-IDF</span> | <span>Pandas</span> | <span>Jupyter Notebook</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
